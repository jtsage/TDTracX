...
/**
 * ShowUserPermsFixture
 *
 */
class ShowUserPermsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_paid' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        'is_budget' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        '_indexes' => [
